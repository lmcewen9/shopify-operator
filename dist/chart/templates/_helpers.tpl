...
*/}}
{{- define "shopify-operator.fullname" -}}
...
*/}}
{{- define "shopify-operator.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "shopify-operator.resourceName" -}}
{{- $fullname := include "shopify-operator.fullname" .context }}
{{- $suffix := .suffix }}
